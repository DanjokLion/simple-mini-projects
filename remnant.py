...
Метод работы: 
 Данный код будет работать только если в папке с этим кодом находятся файлы из списка далее:
    ...
    остатки.xlsx - файл должен быть отредактирован макросом 'обработка выгрузок из 1с';
    продажи.xlsx - файл должен быть отредактирован макросом 'обработка выгрузок из 1с';
